...
const API_LIST: ApiEndpoint[] = [
  ...
  },
  {
    ...
    method: 'PUT',
    path: '/api/v1/posts/1',
    title: '5. 게시글 / 계층형 답글 수정',
    authRequired: false,
    description: '원 게시글 또는 계층형 답글의 제목(title), 본문(content), 작성자명(author_name)을 수정합니다.',
    headers: {
      'Content-Type': 'application/json',
    },
    bodyExample: {
  ...
  },
  {
    ...
    method: 'DELETE',
    path: '/api/v1/posts/1',
    title: '6. 게시글 및 하위 답글 삭제 (논리 삭제)',
    authRequired: false,
    description: '게시글 및 해당 글에 딸린 하위 답글을 삭제됨(IS_DELETED=Y) 상태로 연쇄 전환합니다.',
    headers: {},
    responseExample: {
      success: true,
  ...
  },
  {
    ...
    title: '9. 댓글 / 대댓글 단건 상세 조회',
    authRequired: false,
    description: '특정 댓글 또는 대댓글의 상세 정보를 조회합니다.',
    headers: {},
    responseExample: {
      success: true,
      data: {
  ...
  },
  {
    ...
    title: '10. 댓글 / 대댓글 수정',
    authRequired: false,
    description: '작성한 댓글 또는 대댓글의 내용(content)과 작성자명(author_name)을 수정합니다. (/api/v1/posts/1/comments/1 경로로도 가능)',
    headers: {
      'Content-Type': 'application/json',
    },
    bodyExample: {
  ...
  },
  {
    ...
    method: 'DELETE',
    path: '/api/v1/comments/1',
    title: '11. 댓글 및 하위 대댓글 삭제 (논리 삭제)',
    authRequired: false,
    description: '댓글 및 해당 댓글의 하위 대댓글을 삭제됨(IS_DELETED=Y) 상태로 연쇄 전환합니다. (/api/v1/posts/1/comments/1 경로로도 가능)',
    headers: {},
    responseExample: {
      success: true,
